                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        %>
											<img width="200px" height="200px" src="<%= request.getContextPath() %>/uploads/img/<%=objSong.getPicture() %>" alt="<%= objSong.getName()%>"/>
                                        <% } else { %>
	                                         <img width="200px" height="200px" src="<%= request.getContextPath() %>/uploads/img/nopicture.png" alt="No picture"/>
	                                    <%} %>
                                        </td>
