...
<nav class="navbar-default navbar-side" role="navigation">
	<div class="sidebar-collapse">
		<ul class="nav" id="main-menu">
			...
			<li><a id="repCom"
				href="<%=request.getContextPath()%>/admin/reply"><i
					class="fa fa-reply fa-3x"></i> Quản lý Bình luận</a></li>
			<li><a id="dencent"
				href="<%=request.getContextPath()%>/admin/decent/index"><i
					class="fas fa-user-friends fa-3x"></i> Phân Quyền </a></li>
		</ul>
	</div>
</nav>
<%-- <%} %> --%>
